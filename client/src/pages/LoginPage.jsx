    ...
    <div className="flex-1 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 relative w-full overflow-hidden">
      ...
      >
        <GlassCard className="p-8 md:p-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="absolute -right-20 -top-20 w-40 h-40 bg-cyber-accent/10 blur-[40px] rounded-full group-hover:bg-cyber-accent/20 transition-colors duration-700 pointer-events-none"></div>
          ...
          <div className="text-center mb-10 relative z-10">
            <div className="inline-flex items-center justify-center p-4 rounded-full bg-cyber-dark border border-cyber-border mb-6 shadow-inner relative">
              <div className="absolute inset-0 rounded-full border border-cyber-accent/30 animate-[spin_4s_linear_infinite]"></div>
              <Shield className="h-10 w-10 text-cyber-accent drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]" />
            </div>
            <h2 className="text-3xl font-black text-white tracking-tight uppercase">Agent Portal</h2>
          ...
          <div className="text-center pt-8 relative z-10">
            <p className="text-sm text-cyber-muted">
              Unauthorized?{' '}
              <Link to="/register" className="font-bold text-cyber-accent hover:text-white transition-colors duration-200">
